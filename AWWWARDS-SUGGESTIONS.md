# Awwwards CSS Review — 22 Strong Foundation
...
**Alternative:** Keep the light footer but add a full-bleed dark "mission statement" band above it with the 22 Strong logo large and centered — a common Awwwards pattern for nonprofit/cause sites.
